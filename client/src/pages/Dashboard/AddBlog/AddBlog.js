...
const AddBlog = () => {
    ...
    const handlePostBlog = e => {
        ...
        e.preventDefault();
        const data = { name, loaction: location, day, writer: writerName, writerImg: writerImage, desc1: description, facility, accommodation, date, price, category, status: 'pending', blogImg: image, rating };

        fetch('https://tripster-server-production.up.railway.app/postBlog', {
            method: "POST",
            headers: {
    ...
    return (
        <form onSubmit={handlePostBlog}>
            <div className='add-blog container shadow row'>
